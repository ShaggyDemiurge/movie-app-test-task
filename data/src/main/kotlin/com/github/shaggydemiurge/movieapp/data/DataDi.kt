...
import com.github.shaggydemiurge.movieapp.data.preferences.preferencesModule
...
val dataModule = module {
    single { moshi() }
    includes(preferencesModule, networkModule, repositoryModule, dataSourceModule)
}
